...
def game_choice():
    ...
    message_1, message_2, message_3= game(user_selection)
    return flask.render_template("game_2.html", message_1= message_1, message_2= message_2, message_3= message_3, playing= 1)
